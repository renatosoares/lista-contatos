...
$(document).ready(function () {
	...
	setTimeout(function () {
		$.gritter.add({
			...
			image: 'Content/img/demo/demo-avatar9604.jpg',
			sticky: false,
			time: 7000
		});
		return false;
	...
	setTimeout(function () {
		$.gritter.add({
			...
			text: 'Do you have a scheduled <strong class="firebrick">business meeting at 13:30</strong> with Natali McDonalds. <br /><a class="bold" href="widgets-remember.html">Go to Task &raquo;</a>',
			image: 'Content/img/demo/demo-avatar9605.jpg',
			sticky: true,
